...
<body style="font-family: Arial, sans-serif; color: #333;">
    @php
        ...
        $empresaWeb = $empresa === 'Espumados del Litoral S.A'
            ? 'https://www.espumadosdellitoral.com.co/'
            : 'https://www.espumasmedellin.com/';
    @endphp
    ...
    <strong>Equipo {{ $empresaNombre }}</strong></p>

    <p style="text-align: center; margin: 30px 0;">
        <a href="{{ $empresaWeb }}" target="_blank"
           style="background-color: #EC6C35; color: #fff; padding: 12px 24px; text-decoration: none; border-radius: 4px; font-weight: bold;">
